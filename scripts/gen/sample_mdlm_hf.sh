...
python -u main.py \
    ...
    sampling.logdir=/mnt/weka/home/zhihan.yang/samples/owt-mdlm-noeos-1m/blocksize_${BLOCK_SIZE}_tval_${t_value}_numtries_${num_tries_val}_nucleus_${nucleus_p_val}_firsthit_${first_hitting_val}/seed_${seed_val} \
